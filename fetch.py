#!/usr/bin/env python3
"""
Recuperation des codes promo Monoprix depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/monoprix.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/monoprix.fr"
STORE_NAME = "Monoprix"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Monoprix depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-monoprix)"
    }
    try:
